...
| チェア名    | モデル名            | オーナー名 | sessionToken |
| ----------- | ------------------- | ---------- | ------------ |
| QC-L13-8361 | クエストチェア Lite | a          | a            |
| LC-48-2566  | Legacy Chair        | c          | a            |
| IS-33-8740  | Infinity Sea        | d          | a            |
...
`https://isuride.xiv.isucon.net`をブラウザで開き、`Owner Application`ボタンを押します。
preset から選択をし、
